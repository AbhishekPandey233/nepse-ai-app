...
export default function ExplainabilityPage() {
  ...
  async function handleExplain() {
    ...
    try {
      const question = `Explain which factors most influenced the latest prediction for ${ticker} and in which direction`;
